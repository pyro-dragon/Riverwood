...
init -1 python hide:
    ...
    config.window_title = u"Riverwood"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Riverwood"
    config.version = "0.0"
    ...
    theme.marker(
        ...
        #mm_root = "#FDF5E3",
        mm_root = "environments/camp.jpg", #Main-menu background
...
python early:
    config.save_directory = "Riverwood-1422090057"
...
init python:
    ...
    build.executable_name = "Riverwood"
