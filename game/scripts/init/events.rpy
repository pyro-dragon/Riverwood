...
init 0: 
    python:
        ...
        game.gameLoop.addEvent(Event("testEvent1", "morning", 4, True, lambda: True), 3)
        game.gameLoop.addEvent(Event("testEvent1", "afternoon", 4, True, lambda: True), 3)
        ...
        game.gameLoop.addEvent(Event("testEvent3", "morning", 6, True, lambda: True), 5)
        game.gameLoop.addEvent(Event("testEvent3", "afternoon", 6, True, lambda: True), 5)
